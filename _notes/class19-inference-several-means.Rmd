...
difference between the actual observered response minus the fitted
...
Notice that the $R^2$ value is always equal to $0$ for a simple model with just a single
mean.^[Some people use an alternative definition of $R^2$ for models with just a single
mean. I won't do that because its confusing and unnecessary.]
